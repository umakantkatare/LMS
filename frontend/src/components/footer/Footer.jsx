      ...
      <footer className="relative left-0 bottom-0 h-[10vh] py-5 flex flex-col sm:flex-row items-center justify-between text-white bg-gray-800 sm:px-20">
        ...
        <section className="flex gap-4 text-2xl">
          <a href="https://facebook.com" target="_blank" rel="noreferrer">
            <BsFacebook className="text-blue-600 hover:scale-110 transition" />
          </a>

          <a href="https://linkedin.com" target="_blank" rel="noreferrer">
            <BsLinkedin className="text-blue-700 hover:scale-110 transition" />
          </a>

          <a href="https://twitter.com" target="_blank" rel="noreferrer">
            <BsTwitter className="text-blue-600 hover:scale-110 transition" />
          </a>
